...
rule_coap1 = {"ruleid"  : 1,
             "content" : [["IPv6.version",      1,  "bi", 6,                  "equal", "not-sent"],
                          ...
                          ["IPv6.iidES",        1,  "bi", 0x0000000000002212, "equal", "not-sent"],
                          ["IPv6.prefixLA",     1,  "bi", [0x200141d004013100,
                                                           0x00000000000057d7,
                                                           0x200104701f1209f2,
...
rule_coap2 = {"ruleid"  : 2,
             "content" : [["IPv6.version",      1,  "bi", 6,                  "equal",  "not-sent"],
                          ...
                          ["IPv6.prefixES",     1,  "bi", 0x200104701F1209F2, "equal", "not-sent"],
                          ["IPv6.iidES",        1,  "bi", 0x0000000000002212, "equal", "not-sent"],
                          ["IPv6.prefixLA",     1,  "bi", 0x200141D004013100, "equal", "not-sent"],
                          ["IPv6.iidLA",        1,  "bi", 0x00000000000057d7, "equal", "not-sent"],
                          ...
                          ["CoAP.tokenLength",  1,  "bi", 1,                  "equal", "not-sent"],
                          ["CoAP.code",         1,  "up", 2,                  "equal", "not-sent"],
                          ["CoAP.code",         1,  "dw", [68, 132],          "match-mapping", "mapping-sent"],
                          ["CoAP.messageID",    1,  "bi", 0,                  "MSB(12)", "LSB"],
